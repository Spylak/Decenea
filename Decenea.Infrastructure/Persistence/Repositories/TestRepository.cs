...
namespace Decenea.Infrastructure.Persistence.Repositories;
...
public class TestRepository : ITestRepository
{
    ...
    public async Task<TestDto> GetTestDtoByTestId(string testId, string? userId = null)
    {
    ...
    public async Task<IEnumerable<TestDto>> GetManyTestDtos(int countryId,
