...
namespace Decenea.WebAPI.Infrastructure.Migrations
{
    ...
    [Migration("20230818154055_Locations5")]
    partial class Locations5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Decenea.Domain.Entities.LocationEntities.Municipality", b =>
                {
                    ...
                    b.HasOne("Decenea.Domain.Entities.LocationEntities.City", "Seat")
                        .WithOne()
                        .HasForeignKey("Decenea.Domain.Entities.LocationEntities.Municipality", "SeatId");
