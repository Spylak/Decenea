...
public class GetActiveTestQueryHandler : ICommandHandler<GetActiveTestQuery, ErrorOr<TestDto>>
{
    ...
    public async Task<ErrorOr<TestDto>> ExecuteAsync(GetActiveTestQuery query, CancellationToken cancellationToken)
    {
        try
        {
