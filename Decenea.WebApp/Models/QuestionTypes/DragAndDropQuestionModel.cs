...
public class DragAndDropQuestionModel : QuestionBaseModel
{
    public DragAndDropQuestionModel(List<DropZone>? dropzones = null)
    {
        ...
        QuestionType = QuestionTypeValues.DragAndDrop;
    }
